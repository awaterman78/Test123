  ...
  return <div className="app-shell">
    ...
    <main className="workspace">
      <section className="pane transcript-pane">
        ...
        <div className="privacy-strip"><ShieldCheck /><div><strong>Private by default</strong><span>No audio storage and no automatic transcript saving.</span></div><button onClick={saveTranscript} disabled={!transcript.length}><Save />Save transcript</button></div>
      </section>
